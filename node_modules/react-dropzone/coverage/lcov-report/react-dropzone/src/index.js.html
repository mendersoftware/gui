...
<span class="cstat-no" title="statement not covered" >    document.body.onfocus = null;</span>
  }
&nbsp;
  onDragStart(e) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (--this.enterCounter &gt; 0) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.props.onDragLeave) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Feb 23 2017 20:35:12 GMT+0000 (UTC)
</div>
</div>
