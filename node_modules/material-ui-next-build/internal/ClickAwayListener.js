...
var bind = function bind(callback) {
  clickAwayEvents.forEach(function (event) {
    return (0, _on2.default)(document, event, callback);
  });
};
var unbind = function unbind(callback) {
  clickAwayEvents.forEach(function (event) {
    return (0, _off2.default)(document, event, callback);
  });
};
  ...
  function ClickAwayListener() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = ClickAwayListener.__proto__ || (0, _getPrototypeOf2.default)(ClickAwayListener)).call.apply(_ref, [this].concat(args))), _this), _this.mounted = false, _this.handleClickAway = function (event) {
      ...
      if (_this.mounted) {
        ...
        if (document && document.documentElement && document.documentElement.contains(event.target) && !isDescendant(el, event.target)) {
