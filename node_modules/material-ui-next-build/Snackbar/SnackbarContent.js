...
SnackbarContent.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  message: typeof babelPluginFlowReactPropTypes_proptype_Element === 'function' ? babelPluginFlowReactPropTypes_proptype_Element : require('prop-types').shape(babelPluginFlowReactPropTypes_proptype_Element).isRequired
} : {};
