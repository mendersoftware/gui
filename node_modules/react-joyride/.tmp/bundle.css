...
.demo .hero {
  ...
  .demo .hero__start {
    ...
    padding: 0 2rem;
    text-align: center; }
    .demo .hero__start:active, .demo .hero__start:focus, .demo .hero__start:hover {
      color: #fff;
      text-decoration: none; }
  .demo .hero__tooltip {
    background-color: #ff8145;
    ...
    width: 2rem; }
    .demo .hero__tooltip:active, .demo .hero__tooltip:focus, .demo .hero__tooltip:hover {
      color: #fff;
      text-decoration: none; }
