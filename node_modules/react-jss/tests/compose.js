...
var cov_a299mdxt = function () {
  var path = "/Users/kof/work/cssinjs/react-jss/src/compose.js",
      hash = "323c23b17178c4c5038e42caeba49030dce105c1",
      global = new Function('return this')(),
      gcv = "__coverage__",
      coverageData = {
    path: "/Users/kof/work/cssinjs/react-jss/src/compose.js",
    statementMap: {
      "0": {
        start: {
          line: 10,
...
exports["default"] = function (staticSheet, styles) {
  ...
  for (var name in styles) {
    var className = (++cov_a299mdxt.s[1], staticSheet.classes[name]);
    ++cov_a299mdxt.s[2];
    if (!className) {
        ++cov_a299mdxt.b[0][0];
        ++cov_a299mdxt.s[3];
  ...
  if (styles) {
    ...
    for (var _name in staticSheet.classes) {
      var _className = (++cov_a299mdxt.s[7], styles[_name]);
      ++cov_a299mdxt.s[8];
      if (!_className) {
        ++cov_a299mdxt.b[2][0];
        ++cov_a299mdxt.s[9];
