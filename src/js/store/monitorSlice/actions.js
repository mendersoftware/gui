...
import { getDeviceFilters, getSearchEndpoint } from '@store/selectors';
...
export const changeNotificationSetting = createAsyncThunk(`${sliceName}/getIssueCountsByType`, ({ enabled, channel = alertChannels.email }, { dispatch }) => {
