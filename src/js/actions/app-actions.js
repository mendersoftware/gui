...
*/
  ...
  getGroupDevices: function(group, callback, page = default_page, per_page = default_per_page) {
  ...
  getDevices: function(callback, page = default_page, per_page = default_per_page, search_term) {
  ...
  getNumberOfDevicesInGroup: function(callback, group) {
    ...
    function getDeviceCount() {
      DevicesApi.get(`${inventoryApiUrl}${forGroup}/devices?per_page=${per_page}&page=${page}${ungroupedFilter}`)
        .then(function(res) {
...
*/
  ...
  */
  ...
  getDeploymentsInProgress: function(callback, page = default_page, per_page = default_per_page) {
  ...
  getPastDeployments: function(callback, page = default_page, per_page = default_per_page, startDate, endDate, group) {
  ...
  getPendingDeployments: function(callback, page = default_page, per_page = default_per_page) {
