...
export class ReviewDevices extends React.Component {
  render() {
    return (
      <div>
...
export class AuthDevices extends React.Component {
  render() {
    return (
      <div>
...
export class DevicesNav extends React.Component {
  render() {
    return (
      <div>
        <h3>Devices</h3>
        ...
        {this.props.devices ? (
          <div>
            <p>
              There {this.props.devices === 1 ? 'is a device' : 'are devices'} waiting to be connected to the Mender server. Before you can manage any
...
export class ArtifactsNav extends React.Component {
  render() {
    return (
      <div>
        <h3>Artifacts</h3>
...
export class DeploymentsNav extends React.Component {
  render() {
    return (
      <div>
...
export class UploadArtifact extends React.Component {
  render() {
    ...
    return (
      <div>
        ...
        <hr />
        <p>
          Before you can deploy an update to devices, you need to upload an Artifact. A Mender Artifact is a file format that includes some metadata and the
          root file system that is to be deployed.
        </p>
        ...
        {isHosted && multitenancy ? (
          ...
          <p>
            ...
            <a href={`https://docs.mender.io/${docsVersion}getting-started/download-test-images`} target="_blank">
              download a test Mender Artifact
            </a>{' '}
            for your virtual devices. After the download finishes, upload the Artifact here.
          </p>
        )}
...
export class CreateDeployment extends React.Component {
  render() {
    return (
      <div>
        <h3>Create a deployment</h3>
...
export class ProgressDeployment extends React.Component {
  render() {
    return (
      <div>
...
export class FinishedDeployment extends React.Component {
  render() {
    return (
      <div>
