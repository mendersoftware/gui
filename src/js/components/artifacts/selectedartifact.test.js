...
describe('transformArtifactCapabilities', () => {
  it('works as expected', () => {
    expect(transformArtifactCapabilities(defaultState.releases.byId.a1.artifact_provides)).toEqual([
    ...
    expect(transformArtifactCapabilities(defaultState.releases.byId.a1.clears_artifact_provides)).toEqual([
      { key: '0', primary: '0', secondary: 'data-partition.myapp.*' }
    ]);
    expect(transformArtifactCapabilities(defaultState.releases.byId.a1.artifact_depends)).toEqual([]);
  });
});
