  ...
  render() {
    ...
    return (
      <div>
        ...
        <p>2. Copy and paste the following to download <span className="code">single-file-artifact-gen</span> and make it executable:</p>
        ...
        <p>3. And <a href="https://dgsbl4vditpls.cloudfront.net/mender-demo-artifact.mender">download the demo application</a>.</p>
        ...
        <p>NOTE: You should replace the <span className="code">generic_x86</span> device type with the type you require.</p>
        <div>
          <div className="code">
        ...
        <p>You should now have a new Artifact file called <span className="code">demo-webserver-updated.mender</span>!</p>
        <p>If you upload this Artifact to the Mender server, it will create a new Release. You can then deploy this new Release of the webserver demo to your device, and when it has updated successfully you should see the page content will have been replaced with the &quot;Hello world&quot; string you modified.
        </p>
