    ...
    return (
      <div id="software-support">
        ...
        <div className="inline-block" style={{width:"50%", marginRight:"10%"}}>
          ...
          <p>
            Mender offers subscription support to provide you with immediate
            contact to our knowledgable team. We can help you quickly resolve 
            any questions or issues that arise with guaranteed response and
            resolution times.
          </p>
          <p><a href={supportLink} target="_blank">Find out more</a></p>
         </div>
