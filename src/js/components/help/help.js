      ...
      <div style={{marginTop:"-15px"}}>
        ...
        <div className="rightFluid padding-right" style={{maxWidth:"980px", paddingTop: "0", paddingLeft:"45px"}}>
          <div style={{position:"relative", top:"12px"}}>
            <ComponentToShow docsVersion={this.props.docsVersion} getLatest={this._getLatest} isHosted={this.state.isHosted} org={this.state.org} links={this.state.links} hasMultitenancy={this.state.hasMultitenancy} isEmpty={isEmpty} pages={components} changePage={this.changePage} />
