  ...
  render: function() {
    ...
    return (
      <div>
        ...
        <p>Visit <a href="https://hub.mender.io/c/board-integrations" target="_blank">Mender Hub</a> and look for your board - your device may already have been integrated and tested by the community. If so, you can follow the instructions found there to set up the Yocto environment and configure the build.</p>
