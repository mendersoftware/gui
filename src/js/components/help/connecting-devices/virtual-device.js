      ...
      <div>
        ...
        {this.props.isHosted ? (
          <div>
            ...
            <p>
              One virtual device was automatically started for you when your account was created; it will expire after 14 days from account creation. You can
            ...
            <p>
              On the infrastructure you run the virual Mender client, you need to be able to create outgoing TCP connections to hosted.mender.io and
            ...
            <p>
              ...
              {this.props.hasMultitenancy ? <span>(we have pasted in your specific tenant token)</span> : null}
            </p>
          ...
          <div>
            ...
            <h3>Prerequisites</h3>
            <p>
              The test environment should be set up and working successfully as described in the{' '}
              <a href={`https://docs.mender.io/${this.props.docsVersion}getting-started/create-a-test-environment`} target="_blank">
                Install a Mender demo server
              </a>{' '}
              documention.
            </p>
            <p>
              You should also download the virtual Artifacts listed on the{' '}
            ...
            <p>
              A minute or two after the server has started, there should be a virtual device pending authorization. This means that the Mender client, which
