  ...
  render: function() {
    ...
    return (
      <div>
        ...
        : 
          <div>
            <p>A full tutorial for deploying to physical devices - including BeagleBone Black - is available <a href={"https://docs.mender.io/"+this.props.docsVersion+"getting-started/deploy-to-physical-devices"} target="_blank">here on our docs site</a>. To make testing easy, we also provide demo images for BeagleBone Black in the tutorial.</p>
          </div>
        }
