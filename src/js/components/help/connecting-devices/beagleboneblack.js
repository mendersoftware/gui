  ...
  render: function() {
    ...
    return (
      <div>
        ...
        <p>Before powering on the BeagleBone Black, press the <a href="https://docs.mender.io/user/pages/03.1.3/01.Getting-started/05.Deploy-to-physical-devices/beaglebone_black_sdboot.png" target="_blank">S2 button</a> and keep the button pressed for about 5 seconds while booting (power is connected). This will make the BeagleBone Black boot from the SD card instead of internal storage.</p>
