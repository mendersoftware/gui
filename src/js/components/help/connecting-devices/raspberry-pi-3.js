      ...
      <div>
        ...
        {this.props.isHosted ? (
          <div>
            ...
            <p>
              Enabling Wifi is most easily done by first downloading the{' '}
              <a
                target="_blank"
                rel="noopener noreferrer"
                href={'https://docs.mender.io/development/getting-started/deploy-to-physical-devices#mender-artifact-tool'}
              >
            ...
            {!this.props.isEmpty(sdimg) ? (
              <div>
                <p>
                  <a href={sdimg.href}>Download the disk image for Raspberry Pi 3 here</a>.
                </p>
                <p>
            ...
            {artifacts.length > 1 ? (
              <p>
                Download these two Raspberry Pi 3 Artifacts customized for your Hosted Mender account: <a href={artifacts[1].href}>{artifacts[1].name}</a>,{' '}
