     ...
     if (versions.length >1) {
      ...
      for (var fileName in this.props.links.links.raspberrypi3[version]) {
        if (fileName.indexOf('sdimg') != -1) {
          sdimg = {name: fileName, href:this.props.links.links.raspberrypi3[version][fileName]};
      ...
      <div>
        ...
        {this.props.isHosted ? 
          ...
          <div>
            ...
            <p>If you would like to use a different device type, please see the page on <a onClick={this.props.changePage.bind(null, "help/connecting-devices/provision-a-demo/beagleboneblack")}>BeagleBone Black</a> or <a onClick={this.props.changePage.bind(null, "help/connecting-devices/build-with-yocto")}>Build with Yocto Project</a>.</p>
        ...
        : 
          <div>
            <p>A full tutorial for deploying to physical devices - including RaspberryPi 3 - is available <a href={"https://docs.mender.io/"+this.props.docsVersion+"getting-started/deploy-to-physical-devices"} target="_blank">here on our docs site</a>. To make testing easy, we also provide demo images for RaspberryPi 3 in the tutorial.</p>
          </div>
