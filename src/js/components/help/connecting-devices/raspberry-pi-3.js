    ...
    return (
      <div>
        ...
        {!this.props.isEmpty(link) ? 
          <p><a href={link.href}>Download the disk image for Raspberry Pi 3 here</a>.</p>
        ...
        {this.props.isHosted ? 
          <p>Download these two Raspberry Pi 3 Artifacts customized for your Hosted Mender account: TODO LINKS: Artifact1, [Artifact2].</p>
          :
