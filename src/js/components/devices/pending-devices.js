...
import { getDevicesByStatus, selectGroup, setDeviceFilters, updateDeviceAuth } from '../../actions/deviceActions';
...
const actionCreators = { getDevicesByStatus, selectGroup, setDeviceFilters, setSnackbar, updateDeviceAuth };
