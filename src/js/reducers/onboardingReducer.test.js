...
describe('organization reducer', () => {
  ...
  it('should handle SET_SHOW_CREATE_ARTIFACT', () => {
  ...
  it('should handle SET_SHOW_ONBOARDING_HELP', () => {
  ...
  it('should handle SET_SHOW_ONBOARDING_HELP_DIALOG', () => {
  ...
  it('should handle SET_ONBOARDING_COMPLETE', () => {
  ...
  it('should handle SET_ONBOARDING_PROGRESS', () => {
  ...
  it('should handle SET_ONBOARDING_DEVICE_TYPE', () => {
  ...
  it('should handle SET_ONBOARDING_APPROACH', () => {
  ...
  it('should handle SET_ONBOARDING_ARTIFACT_INCLUDED', () => {
