...
describe('device reducer', () => {
  ...
  it('should handle RECEIVE_GROUP_DEVICES', () => {
    expect(
      reducer(undefined, {
  ...
  it('should handle RECEIVE_DYNAMIC_GROUPS', () => {
  ...
  it('should handle REMOVE_FROM_GROUP', () => {
    let state = reducer(undefined, { type: DeviceConstants.RECEIVE_GROUPS, groups: defaultState.devices.groups.byId });
  ...
  it('should handle ADD_DYNAMIC_GROUP', () => {
    expect(
  ...
  it('should handle ADD_STATIC_GROUP', () => {
    expect(
  ...
  it('should handle SELECT_DEVICE', () => {
  ...
  it('should handle SELECT_DEVICES', () => {
  ...
  it('should handle SET_DEVICE_FILTERS', () => {
    expect(
  ...
  it('should handle SET_FILTER_ATTRIBUTES', () => {
  ...
  it('should handle SET_TOTAL_DEVICES', () => {
  ...
  it('should handle SET_DEVICE_LIMIT', () => {
  ...
  it('should handle RECEIVE_DEVICE', () => {
  ...
  it('should handle RECEIVE_DEVICE_AUTH', () => {
    expect(
      reducer(undefined, {
  ...
  it('should handle SET_INACTIVE_DEVICES', () => {
    expect(
  ...
  it('should handle SET_<authstatus>_DEVICES', () => {
  ...
  it('should handle SET_<authstatus>_DEVICES_COUNT', () => {
    Object.values(DeviceConstants.DEVICE_STATES).forEach(status => {
