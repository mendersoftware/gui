...
describe('device reducer', () => {
  ...
  it('should handle RECEIVE_DEPLOYMENT', () => {
  ...
  it('should handle RECEIVE_DEPLOYMENT_STATS', () => {
  ...
  it('should handle RECEIVE_DEPLOYMENT_DEVICE_LOG', () => {
  ...
  it('should handle RECEIVE_<deploymentstatus>_DEPLOYMENTS', () => {
  ...
  it('should handle SELECT_<deploymentstatus>_DEPLOYMENTS', () => {
    Object.values(DeploymentConstants.DEPLOYMENT_STATES).forEach(status => {
      expect(
  ...
  it('should handle SELECT_DEPLOYMENT', () => {
  ...
  it('should handle REMOVE_DEPLOYMENT', () => {
  ...
  it('should handle CREATE_DEPLOYMENT', () => {
